...
public class FacturaPdfView extends AbstractPdfView {
	...
	protected void buildPdfDocument(Map<String, Object> model, Document document, PdfWriter writer,
		...
		tabla.addCell(empresa.getNombre());
		tabla.addCell(empresa.getDireccion());
		...
		tabla2.addCell(cell);
		tabla2.addCell(mensajes.getMessage("text.cliente.factura.folio") + ": " +  empresa.getId());
		tabla2.addCell(mensajes.getMessage("text.cliente.factura.descripcion") + ": " + empresa.getDireccion());
		tabla2.addCell(mensajes.getMessage("text.cliente.factura.fecha") + ": " + empresa.getCreateAt());
